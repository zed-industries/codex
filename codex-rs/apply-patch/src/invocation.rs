...
mod tests {
    ...
    fn test_implicit_patch_single_arg_is_error() {
        ...
        assert_matches!(
            maybe_parse_apply_patch_verified(&args, dir.path(), &crate::StdFs),
...
"#,
        ...
        let diff = unified_diff_from_chunks(&path, chunks, &crate::StdFs).unwrap();
...
*** End Patch"#
        ...
        let result = maybe_parse_apply_patch_verified(&argv, session_dir.path(), &crate::StdFs);
