...
pub async fn run_acp_tool_session(
    id: RequestId,
    ...
    run_acp_tool_session_inner(codex, outgoing, id).await;
}

pub async fn run_acp_tool_session_reply(
    codex: Arc<Codex>,
    outgoing: Arc<OutgoingMessageSender>,
    ...
    run_acp_tool_session_inner(codex, outgoing, request_id).await;
}

async fn run_acp_tool_session_inner(
    codex: Arc<Codex>,
    outgoing: Arc<OutgoingMessageSender>,
    request_id: RequestId,
) {
